...
public class Entities
{
    ...
    public static final String decode(String entity) {
        ...
        if (entity.charAt(1) == '#') {
            ...
            final Character c = new Character((char)Integer.parseInt(entity.substring(start), radix));
            return c.toString();
        }
        final String s = Entities.decoder.get(entity);
        if (s != null) {
            return s;
        }
        return "";
    ...
    public static final String encode(final String s) {
        ...
        for (int i = 0; i < length; ++i) {
            final int j;
            final char c = (char)(j = s.charAt(i));
    ...
    static final void add(final String entity, final int value) {
    ...
    static {
        decoder = new Hashtable<String, String>(300);
